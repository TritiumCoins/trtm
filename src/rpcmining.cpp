...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    //ChangedForTritium
	if (vNodes.empty())
        throw JSONRPCError(-9, "Tritium is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Tritium is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    //ChangedForTritium
	if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Tritium is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Tritium is downloading blocks...");
