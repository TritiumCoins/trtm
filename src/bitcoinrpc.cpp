...
{
    //ChangedForTritium
	return GetBoolArg("-testnet", false) ? 26001 : 16001;
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Tritium server (and possibly override the detachdb config value).");
