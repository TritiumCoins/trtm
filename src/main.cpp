...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tritium", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Times 10/Mar/2017 Tritium is going to start";
        CTransaction txNew;
        txNew.nTime = 1489343505;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 0 << CBigNum(42) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 15000 * COIN;
        ...
        block.nVersion = 1;
        block.nTime    = 1489343505;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 860899 : 216178;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x52ab4bd4c231a8ffb93d3123d09c1392f2b6b63c008ff553dcf4d801d375d122"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x70, 0x35, 0x22, 0x07 };
